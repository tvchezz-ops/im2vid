...
from app.services import crypto_payments
...
async def test_stub_crypto_provider_creates_draft_order_without_crediting(session_factory, monkeypatch) -> None:
    monkeypatch.setattr(crypto_payments.settings, "crypto_wallet_usdt_trc20", "TWalletAddress")
    async with session_factory() as session:
        ...
        assert invoice.address == "TWalletAddress"
        ...
        assert crypto_order.wallet_address == "TWalletAddress"
